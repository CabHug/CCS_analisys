...
def mapear_categorias(df_ventas, df_categorias_lookup, columna_lookup, columna_ventas):
    ...
    por el índice (ID) correspondiente de la tabla de categorías.
        ...
        df_categorias_lookup (pd.DataFrame): Tabla de referencia con el índice (ID) y la columna de categorías.
        columna_categoria (str): Nombre de la columna que contiene las categorías en df_ventas y df_categorias_lookup.
        columna_vntas (str): Nombre de la columna que quiero cambiar en df_ventas.
    Returns:
...
for column_lookup in work_colums:
    ...
    try:
        ...
        print(f"\n🤖⚠️ Mapeo fallido: {e}")
""" 
raw_conslidate_df.rename(columns={
